...
const navItems = [
    {
        ...
        href: '/platform',
        children: [
            { label: 'Platform Overview', href: '/platform#overview', icon: <Cpu className="w-4 h-4 text-orange-500" /> },
            { label: 'Features Catalog', href: '/features', icon: <Sparkles className="w-4 h-4 text-orange-500" /> },
            { label: 'Voice AI Agent', href: '/features?product=voicebot#how-it-works', icon: <PhoneCall className="w-4 h-4 text-orange-500" /> },
            { label: 'Integrations', href: '/integrations#channels', icon: <Network className="w-4 h-4 text-orange-500" /> },
            { label: 'Security & DPDP', href: '/security#dpdp-compliance', icon: <Shield className="w-4 h-4 text-orange-500" /> },
        ],
    },
    {
        label: 'Solutions',
        href: '/solutions',
        children: [
            { label: 'Solutions Matrix', href: '/solutions#products', icon: <Bot className="w-4 h-4 text-orange-500" /> },
            { label: 'Customer Service', href: '/solutions/customer-service#modules', icon: <Headphones className="w-4 h-4 text-orange-500" /> },
            { label: 'IT Helpdesk', href: '/solutions/it-helpdesk#automation', icon: <Briefcase className="w-4 h-4 text-orange-500" /> },
            { label: 'Banking & BFSI', href: '/solutions/banking#use-cases', icon: <Landmark className="w-4 h-4 text-orange-500" /> },
            { label: 'Insurance', href: '/solutions/insurance#claims', icon: <FileText className="w-4 h-4 text-orange-500" /> },
            { label: 'Healthcare', href: '/solutions/healthcare#use-cases', icon: <Activity className="w-4 h-4 text-orange-500" /> },
        ],
    },
    {
        label: 'Resources',
        ...
        children: [
            ...
            { label: 'Why SwanDigitals', href: '/why-swandigitals#comparison', icon: <GitCompare className="w-4 h-4 text-orange-500" /> },
